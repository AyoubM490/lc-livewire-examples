                ...
                <div class="max-w-lg mx-auto lg:max-w-none">
                    <form wire:submit.prevent="submitForm"
                        ...
                        <div class="mt-6">
                            ...
                            <div class="relative rounded-md shadow-sm">
                                <input id="email" wire:model="email" type="text" name="email" value="{{ old('email') }}"
                        ...
                        <div class="mt-6">
                            ...
                            <div class="relative rounded-md shadow-sm">
                                <input id="phone" wire:model="phone" name="phone" value="{{ old('phone') }}"
                        ...
                        <div class="mt-6">
                            ...
                            <div class="relative rounded-md shadow-sm">
                            <textarea id="message" wire:model="message" rows="4" name="message"
